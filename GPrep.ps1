...
foreach ($app in $apps) {
    winget install -e --id $app --accept-package-agreements --accept-source-agreements --disable-interactivity --force
}
...
foreach ($package in $wingetPackages) {
    winget install -e --id $package --accept-package-agreements --accept-source-agreements --disable-interactivity --force
}
